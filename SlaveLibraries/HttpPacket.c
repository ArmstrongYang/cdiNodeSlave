 ...
 *  @return  void
 **********************************************************************/
void Http_setHostAddress(char* hostAddr)
{
 ...
 *  @return  void
 **********************************************************************/
void Http_updateUrlParameterWith(char* key, char* value)
{
 ...
 *  @return  void
 **********************************************************************/
void Http_clearUrlParameter(void)
{
    for(int i = 0; i < URLPAPACNT; i++)
    {
        free(urlParaArr[i]);
 ...
 *  @return  void
 **********************************************************************/
void Http_removeUrlParameter(char* key)
{
    int i;
    int tmp = urlParaIsExist(key);
 ...
 *                  i            参数存在，并返回参数的index
 **********************************************************************/
int Http_urlParaIsExist(char* key)
{
    int i;
    char buf[20];
 ...
 *  @return   void
 **********************************************************************/
void Http_addUrlParameter(char* key, char* value)
{
    int i = 0, len = 0;
    char buf[20];
    char tmp[20];
 ...
 *  @return   void
 **********************************************************************/
void Http_setDevId(char* Dev_Id)
{
    devId = Dev_Id;
    return;
}
 ...
 *  @return   void
 **********************************************************************/
void Http_setDataStreamId(char* StreamId)
{
 ...
 *  @return   void
 **********************************************************************/
void Http_setTriggerId(char* TrigId)
{
    triggerId = TrigId;
    return;
}
 ...
 *  @return   void
 **********************************************************************/
void Http_setAccessKey(char* key)
{
    accessKey = key ;
    return;
}
 ...
 *  @return   void
 **********************************************************************/
void Http_productGetUrl(RESRC_TYPE Type)
{
    int len = 0;
